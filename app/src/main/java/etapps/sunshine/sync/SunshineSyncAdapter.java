...
// when they walk out the front door.
            ...
            if (cVVector.size() > 0) {
                ...
                String yesterdayDate = WeatherEntry.getdbDateString(cal.getTime());
    ...
    public void notifyWeather(double high, double low, String description, int weatherId) {
        Context context = getContext();
        //checking the last update and notify if it' the first of the day
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String lastNotificationKey = context.getString(R.string.pref_last_notification);
        String notifyKey = context.getString(R.string.notifications);
        long lastSync = prefs.getLong(lastNotificationKey, 0);
        boolean notifyOn = prefs.getBoolean(notifyKey, true);

        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS && notifyOn) {
